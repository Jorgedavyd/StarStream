...
class ACE:
    class SIS(CDAWeb):
        ...
        url = lambda self, date: f'https://cdaweb.gsfc.nasa.gov/sp_phys/data/ace/sis/level_2_cdaweb/sis_h1/{date[:4]}/ac_h1_sis_{date}_{SIS_version(date)}.cdf'
    ...
    class MAG(CDAWeb):
        ...
        variables = ['Bnorm', 'BGSM_x', 'BGSM_y', 'BGSM_z', 'SC_GSM_x', 'SC_GSM_y', 'SC_GSM_z', 'dBrms', 'BGSE_x', 'BGSE_y', 'BGSE_z', 'SC_GSE_x', 'SC_GSE_y', 'SC_GSE_z']
        url = lambda self, date: f'https://cdaweb.gsfc.nasa.gov/sp_phys/data/ace/mag/level_2_cdaweb/mfi_h0/{date[:4]}/ac_h0_mfi_{date}_{MAG_version(date)}.cdf'
    ...
    class SWEPAM(CDAWeb):
        ...
        variables = phy_obs[:4] + ['VGSE_x', 'VGSE_y', 'VGSE_z', 'VGSM_x', 'VGSM_y', 'VGSM_z'] 
        url = lambda self, date: f'https://cdaweb.gsfc.nasa.gov/sp_phys/data/ace/swepam/level_2_cdaweb/swe_h0/{date[:4]}/ac_h0_swe_{date}_{SWEPAM_version(date)}.cdf'
    ...
    class SWICS(CDAWeb):
        ...
        variables = phy_obs
        url = lambda self, date: f'https://cdaweb.gsfc.nasa.gov/sp_phys/data/ace/swics/level_2_cdaweb/swi_h6/{date[:4]}/ac_h6_swi_{date}_v03.cdf'
    ...
    class EPAM(CDAWeb):
        ...
        url = lambda self, date: f'https://cdaweb.gsfc.nasa.gov/sp_phys/data/ace/epam/level_2_cdaweb/epm_h1/{date[:4]}/ac_h1_epm_{date}_{EPAM_version(date)}.cdf'
